...
/**
* 
* Cette classe permet la génération d'un profil astral personnalisé pour chaque 
* client ainsi que la génération de prédictions selon les niveaux d'amour, de 
* santé et de travail du client, sur une échelle de 1 à 4.
* 
*/
